...
public class LimeArtifactSpecialized extends ArtifactEnchantment {
   public LimeArtifactSpecialized(File file) {
      super(file);
   }
   ...
   public DustOptions getOptions() {
      return new DustOptions(Color.fromRGB(3, 252, 140), 1.0F);
   }
}
