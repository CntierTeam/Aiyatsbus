...
public class InfernalTouch extends EventExecutor implements FoliaNeeded {
   ...
   public void blockDropItem(int level, BlockDropItemEvent event) {
      ...
      if (blockName.endsWith("ORE") || blockName.equals("STONE") || blockName.equals("NETHERRACK") || blockName.equals("SAND")) {
         boolean flag = false;
